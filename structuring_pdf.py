"""The python script to create a structured pdf"""
...
class StructuredPDF(FPDF):
    """The class to create a StructuredPDF class

    Args:
        FPDF (fpdf): Some class instance
